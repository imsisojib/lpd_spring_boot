...
INSERT INTO lpd.divisions (`id`, `name`, `bn_name`, `url`) VALUES
...
SELECT * FROM lpd.divisions;

CREATE TABLE lpd.districts (
  `id` int(2) NOT NULL,
...
INSERT INTO lpd.districts (`id`, `division_id`, `name`, `bn_name`, `lat`, `lon`, `url`) VALUES
...
INSERT INTO lpd.upazilas (`id`, `district_id`, `name`, `bn_name`, `url`) VALUES
